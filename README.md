...
![equation](https://latex.codecogs.com/gif.latex?100&space;\mu&space;m&space;\text{&space;Background}=&space;70&space;\mu&space;m&space;\text{&space;Background}&space;\times&space;\Big(\frac{100\mu\text{m&space;Image}&space;}{70&space;\mu&space;m\text{&space;Background}&space;}\Big)_{Med}" title="100 \mu m \text{ Background}= 70 \mu m \text{ Background} \times \Big(\frac{100\mu\text{m Image} }{70 \mu m\text{ Background} }\Big)_{Med})
## SED Fitting
## Final Files
